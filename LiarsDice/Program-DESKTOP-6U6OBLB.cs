...
namespace LiarsDice //MAIN PROGRAM - MAKE SURE TO SAVE  ==============================================
{
    class Program
    {
        ...
        start:
            ...
            {
                Console.WriteLine("error - invalid input"); goto start;
            }
            switch (input)
            {
                case 1: Rules(); goto start;
                case 2: GameParameters(); break;
                case 3: ChangeTextures(false); break;
                case 4: setPlayerColor(); goto start;
                case 5: Environment.Exit(1); break;
                default: Console.WriteLine("Invalid input."); goto start;
            }
        }
        static void Rules()
        {
        ...
        static void setPlayerColor()
        {
            ...
            Console.Clear();
            Console.Write("set all player colours...\n");
            outputColours();
            for (int i = 0; i < 4; i++)
            {
                Console.Write("player {0} -enter the colour set you want: ", i + 1);
